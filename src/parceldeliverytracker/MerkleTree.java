...
public class MerkleTree {
    ...
    /**     * @implNote     * Set the transaction list to the MerkleTree object.     *      * @param tranxLst     */    private MerkleTree(List<String> tranxLst) {
        super();
    ...
    /**     * @implNote     * Build merkle tree      *      * @implSpec      * + build() : void     */    public void build() {
    ...
    /**     * @implNote     * Generate hashes of transactions      *      * @implSpec      * - genTranxHashLst(List<String>) : List<String>     */    private List<String> genTranxHashLst(List<String> tranxLst) {
