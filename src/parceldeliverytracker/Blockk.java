...
public class Blockk implements Serializable {
    ...
    // Define the maximum size limit for the transaction list
...
//    }
    @Override
    public String toString() {
        return "Block [blockHeader=" + blockHeader + ", tranxLst=" + showString(transactionsLst) + "]";
    }

    public String showString(ArrayList<Transaction> transactionsLst) {
        return "Transaction [SIZE=" + Blockchainn.MAX_TXN_LIST_SIZE + ", transactionsLst=" + transactionsLst + "]";
    }
}
